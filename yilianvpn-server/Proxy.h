...
public:
	...
	bool isExpire()
	{
		return (std::time(NULL) - clientSocket.lastClientRefreshTime) > Config::PROXY_EXPIRE_TIME || (std::time(NULL) - clientSocket.lastServerRefreshTime) > Config::PROXY_EXPIRE_TIME;
	}
